...
{
    public class AssetSettingsAnalyzeTreeView : TreeView
    {
    ...
    public class AnalyzeTreeViewItemBase : TreeViewItem
    {
    ...
    public class AnalyzeRuleContainerTreeViewItem : AnalyzeTreeViewItemBase
    {
