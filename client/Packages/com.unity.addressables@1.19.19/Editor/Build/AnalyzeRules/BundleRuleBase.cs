...
namespace UnityEditor.AddressableAssets.Build.AnalyzeRules
{
    ...
    {
        [NonSerialized] protected List<GUID> m_AddressableAssets = new List<GUID>();
        [NonSerialized] public Dictionary<string, List<GUID>> m_ResourcesToDependencies = new Dictionary<string, List<GUID>>();
        [NonSerialized]
        internal readonly List<ContentCatalogDataEntry> m_Locations = new List<ContentCatalogDataEntry>();
        [NonSerialized] public readonly List<AssetBundleBuild> m_AllBundleInputDefs = new List<AssetBundleBuild>();
        [NonSerialized]
