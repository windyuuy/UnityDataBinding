...
namespace UnityEngine.AddressableAssets.ResourceLocators
{
    ...
    public class ContentCatalogData
    {
        ...
        class CompactLocation : IResourceLocation
        {
            ...
            public CompactLocation(ResourceLocationMap locator, string internalId, string providerId, object dependencyKey, object data, int depHash, string primaryKey, SerializedType type)
            {
                m_Locator = locator;
